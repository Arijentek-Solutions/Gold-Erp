    ...
    >
        ...
        <div class="p-4 flex-1 flex flex-col">
            ...
            <div class="mt-auto pt-3 border-t border-gray-50 flex items-center justify-between">
                ...
                <button
                    @click.stop="quickAdd"
                    class="bg-gray-900 text-white p-2 rounded-lg hover:bg-gray-700 transition-colors shadow-md active:scale-95"
                    title="Add to Cart"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
...
<script setup>
import { useCartStore } from '@/stores/cart.js' // 👈 Import Store
...
// ⚡ Quick Add Logic
function quickAdd() {
    // We send the 'item' prop directly to the store
    // The store's new 'smart logic' will handle the rest
