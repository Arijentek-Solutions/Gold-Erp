<template>
	<div
		...
		:class="isDark ? 'shadow-2xl shadow-black/50' : 'shadow-xl'"
	>
		<!-- Main Banner -->
		<div
		...
		>
			...
			>
				...
				<div class="absolute inset-0 overflow-hidden">
					...
					<div class="absolute top-10 right-20 text-6xl opacity-20 animate-float">
						💎
					</div>
					<div
						class="absolute bottom-20 right-32 text-4xl opacity-15 animate-float-delayed"
					>
						✨
					</div>
					<div class="absolute top-1/3 right-1/4 text-5xl opacity-10 animate-float">
						💍
					</div>
				</div>
				...
				<div class="relative h-full flex items-center px-8 sm:px-12 lg:px-16">
					<div class="max-w-lg">
						<!-- Badge -->
						<div
							class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium mb-4"
						...
						<!-- Brand -->
						<div
							class="text-white/70 text-sm font-medium tracking-widest uppercase mb-2"
						>
							ZEVAR
						</div>
						...
						<!-- Title (Script Font) -->
						<h2
							class="text-4xl sm:text-5xl lg:text-6xl font-serif italic text-white mb-4 leading-tight"
						>
							{{ banner.title }}
						</h2>
