<template>
  <div class="h-screen w-screen flex items-center justify-center mesh-gradient-bg bg-portal-bg-dark">
    <div class="w-full max-w-md p-8">
      <!-- Logo -->
      <div class="flex items-center gap-3 justify-center mb-10">
        <div class="size-14 rounded-2xl bg-gradient-to-br from-portal-primary to-portal-accent-indigo flex items-center justify-center shadow-lg shadow-portal-primary/30">
      ...
      <div class="glass-card rounded-2xl p-8">
        ...
        <form @submit.prevent="handleLogin">
          <div class="space-y-4">
            <div>
              <label class="text-xs text-white/50 font-semibold uppercase tracking-wider mb-1 block">Email</label>
            ...
            <div>
              <label class="text-xs text-white/50 font-semibold uppercase tracking-wider mb-1 block">Password</label>
