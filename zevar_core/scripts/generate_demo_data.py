...
RING_STYLES = [
    "Solitaire Diamond Ring", "Halo Engagement Ring", "Three Stone Ring",
    "Eternity Band", "Cluster Ring", "Signet Ring", "Promise Ring",
    "Stackable Ring Set", "Wedding Band", "Anniversary Band",
    "Cocktail Ring", "Statement Ring", "Birthstone Ring"
]

NECKLACE_STYLES = [
    "Rope Chain", "Box Chain", "Cable Chain", "Figaro Chain",
    "Cuban Link Chain", "Herringbone Chain", "Singapore Chain",
    "Diamond Pendant Necklace", "Pearl Strand", "Lariat Necklace",
    "Choker", "Tennis Necklace", "Cross Pendant"
]

EARRING_STYLES = [
    "Diamond Studs", "Hoop Earrings", "Drop Earrings", "Huggie Earrings",
    "Chandelier Earrings", "Threader Earrings", "Stud Set",
    "Pearl Studs", "Dangle Earrings", "Crawler Earrings"
]

BRACELET_STYLES = [
    "Tennis Bracelet", "Cuban Link Bracelet", "Bangle",
    "Charm Bracelet", "Cuff Bracelet", "Chain Bracelet",
    "ID Bracelet", "Beaded Bracelet", "Wrap Bracelet"
]

PENDANT_STYLES = [
    "Diamond Cross", "Heart Pendant", "Initial Pendant", "Evil Eye",
    "Locket", "Birthstone Pendant", "Religious Medal", "Compass Pendant",
    "Key Pendant", "Circle Pendant", "Bar Pendant"
]

WATCH_BRANDS = [
    "Bulova", "Citizen", "Seiko", "Invicta", "Anne Klein",
    "Timex", "Fossil", "Michael Kors", "GUESS", "Casio"
]

WATCH_STYLES = [
    "Classic Automatic", "Chronograph", "Dress Watch", "Sport Watch",
    "Diver's Watch", "Diamond Accent", "Eco-Drive", "Solar Powered"
]

METALS = ["14k Yellow Gold", "14k White Gold", "14k Rose Gold", 
          "10k Yellow Gold", "10k White Gold", "Sterling Silver",
          "18k Yellow Gold", "Platinum", "925 Sterling Silver"]
