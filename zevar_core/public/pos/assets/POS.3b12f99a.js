...
import { u as R, A as J } from "./AppLayout.0fa9b760.js";
import {
	o,
	k as r,
	l as e,
...
import { u as H, a as Z } from "./ui.7e64e684.js";
const ee = {
	...
	ie = { class: "p-4 flex-1 flex flex-col" },
					...
					e("div", te, [
						...
						e("div", ne, [
							t.item.stock_qty <= 0
								...
								: t.item.stock_qty < 5
								? (o(),
								  r("span", le, " Only " + a(t.item.stock_qty) + " left ", 1))
								: h("", !0),
						]),
					]),
					e("div", ie, [
...
const _ = (t) => (W("data-v-5b5c4561"), (t = t()), q(), t),
		...
		setup(t, { emit: d }) {
			const n = t,
				...
				p = D({
					...
					onError(l) {
						console.error("Failed to load item:", l), (c.value = !1);
					},
				});
			M(
				() => n.show,
...
var Pt = P(Bt, [["__scopeId", "data-v-5b5c4561"]]);
const b = (t) => (W("data-v-28cf8fc0"), (t = t()), q(), t),
	Dt = {
		key: 0,
...
var is = P(rs, [["__scopeId", "data-v-28cf8fc0"]]);
