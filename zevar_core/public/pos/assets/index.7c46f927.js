...
const b = "modulepreload",
	...
	j = [
		...
		},
		{
			...
			component: () =>
				u(
					() => import("./POS.612588a3.js"),
					[
						"assets/POS.612588a3.js",
						"assets/POS.431df732.css",
						"assets/AppLayout.b973350d.js",
						"assets/AppLayout.ea131494.css",
						"assets/vendor.b4720657.js",
						"assets/vendor.1875b906.css",
						"assets/ui.3a424cc5.js",
					]
				),
			meta: { requiresAuth: !0 },
		},
		{
			...
			component: () =>
				u(
					() => import("./CatalogueDashboard.80d9db83.js"),
					[
						"assets/CatalogueDashboard.80d9db83.js",
						"assets/CatalogueDashboard.4f9cd92e.css",
						"assets/vendor.b4720657.js",
						"assets/vendor.1875b906.css",
						"assets/ui.3a424cc5.js",
						"assets/ProductModal.a542518c.js",
						"assets/ProductModal.f7b1087a.css",
					]
				),
			meta: { requiresAuth: !0 },
		},
		{
			...
			component: () =>
				u(
					() => import("./CategoryListing.fea0bf93.js"),
					[
						"assets/CategoryListing.fea0bf93.js",
						"assets/CategoryListing.cbc367d9.css",
						"assets/vendor.b4720657.js",
						"assets/vendor.1875b906.css",
						"assets/ProductModal.a542518c.js",
						"assets/ProductModal.f7b1087a.css",
		...
		},
		{
			...
			component: () =>
				u(
					() => import("./RepairTerminal.0c246896.js"),
					[
						"assets/RepairTerminal.0c246896.js",
						"assets/vendor.b4720657.js",
						"assets/vendor.1875b906.css",
						"assets/AppLayout.b973350d.js",
						"assets/AppLayout.ea131494.css",
